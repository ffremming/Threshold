...
// for both Ukeplan (delete/replace/complete) and Planverktøy (none).
export default function WorkoutRow({
  ...
  return (
    <div
      ...
      onDrop={onDrop}
    >
      <span className="pb-week-row-grip" aria-hidden="true" title="Dra for å flytte">
      ...
      <div className="pb-week-row-actions">
        ...
        {onReplace && (
          <button
            ...
            aria-label="Bytt ut fra øktbank"
